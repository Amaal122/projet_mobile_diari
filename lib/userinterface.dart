...
class _UserInterfacePageState extends State<UserInterfacePage> {
  ...
  Widget _buildProfileSettingsList(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        _buildMenuItem(
            icon: Icons.logout, title: 'تسجيل الخروج', isDestructive: true),
      ],
    );
  }
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                    ...
                    child: const Text('اطلب مرة أخرى',
  ...
  void _showRatingBottomSheet(
    BuildContext context, String dishTitle, String imagePath) {
...
class _AddressesPageState extends State<AddressesPage> {
  ...
  Widget _buildAddressCard(
      String title, String details, IconData icon, bool isSelected) {
    return Container(
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          padding: const EdgeInsets.all(20),
          children: [
            _buildFavItem("كسكسي بالخضار", "15.00 د.ت",
                "lib/assets/images/koski.jpg"),
            _buildFavItem("ملوخية تونسية", "22.00 د.ت",
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(price,
                    style: const TextStyle(
                        color: Color(0xFFEE8C2B), fontWeight: FontWeight.bold)),
              ],
            ),
          ),
          IconButton(
            ...
            ElevatedButton(
              onPressed: () {
                if (cardNumberController.text.length >= 4) {
                  String last4 = cardNumberController.text
